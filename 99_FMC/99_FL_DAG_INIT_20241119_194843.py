...
Vaultspeed version: 5.7.2.5, generation date: 2024/11/19 19:48:43
...
if (path_to_mtd / "99_mappings_INIT_20241119_194843.json").exists():
	with open(path_to_mtd / "99_mappings_INIT_20241119_194843.json") as file: 
...
if (path_to_mtd / "99_FL_mtd_INIT_20241119_194843.json").exists():
	with open(path_to_mtd / "99_FL_mtd_INIT_20241119_194843.json") as file: 
