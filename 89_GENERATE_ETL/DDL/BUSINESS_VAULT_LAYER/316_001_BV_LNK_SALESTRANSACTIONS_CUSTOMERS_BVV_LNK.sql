...
DROP VIEW IF EXISTS "DV_BV"."LNK_SALESTRANSACTIONS_CUSTOMERS";
CREATE  VIEW "DV_BV"."LNK_SALESTRANSACTIONS_CUSTOMERS"  AS 
	SELECT 
	...
	FROM "DV_FL"."LNK_SALESTRANSACTIONS_CUSTOMERS" "DVT_SRC"
	;
