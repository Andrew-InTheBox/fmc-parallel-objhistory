CREATE OR REPLACE PROCEDURE "ColruytFMC_PROC"."FMC_UPD_OBJECT_STATUS_DTA_SALES_TRANSACTIONS"(P_LOAD_CYCLE_ID VARCHAR2,
...
var HIST_UPD = snowflake.createStatement( {sqlText: `
	...
	WHERE "HIST_UPD"."LOAD_CYCLE_ID" =  '` + P_LOAD_CYCLE_ID + `'::integer
	  AND "HIST_UPD"."OBJECT_NAME" =  'SALES_TRANSACTIONS'
	;
`} ).execute();
