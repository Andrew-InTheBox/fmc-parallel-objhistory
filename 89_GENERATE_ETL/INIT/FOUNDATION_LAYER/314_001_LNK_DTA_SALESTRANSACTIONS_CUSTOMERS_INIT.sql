CREATE OR REPLACE PROCEDURE "ColruytFMC_PROC"."LNK_DTA_SALESTRANSACTIONS_CUSTOMERS_INIT"()
 RETURNS varchar 
LANGUAGE JAVASCRIPT 
...
var truncate_LNK_TGT = snowflake.createStatement( {sqlText: `
	TRUNCATE TABLE "DV_FL"."LNK_SALESTRANSACTIONS_CUSTOMERS";
`} ).execute();
...
var LNK_TGT = snowflake.createStatement( {sqlText: `
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."LNK_SALESTRANSACTIONS_CUSTOMERS_HKEY" ORDER BY "CHANGE_SET"."LOAD_CYCLE_ID",
