CREATE OR REPLACE PROCEDURE "ColruytFMC_PROC"."LKS_DTA_SALESTRANSACTIONS_PRODUCTS_INIT"()
 RETURNS varchar 
LANGUAGE JAVASCRIPT 
...
var truncate_LKS_TGT = snowflake.createStatement( {sqlText: `
	TRUNCATE TABLE "DV_FL"."LKS_DTA_SALESTRANSACTIONS_PRODUCTS";
`} ).execute();


var LKS_TGT = snowflake.createStatement( {sqlText: `
	INSERT INTO "DV_FL"."LKS_DTA_SALESTRANSACTIONS_PRODUCTS"(
	...
	( 
		SELECT 
			  "STG_INR_SRC"."LNK_SALESTRANSACTIONS_PRODUCTS_HKEY" AS "LNK_SALESTRANSACTIONS_PRODUCTS_HKEY"
	...
	SELECT 
		  "STG_SRC"."LNK_SALESTRANSACTIONS_PRODUCTS_HKEY" AS "LNK_SALESTRANSACTIONS_PRODUCTS_HKEY"
