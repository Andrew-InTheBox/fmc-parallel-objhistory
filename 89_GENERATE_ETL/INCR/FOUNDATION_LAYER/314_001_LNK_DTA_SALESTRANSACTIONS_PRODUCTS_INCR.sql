CREATE OR REPLACE PROCEDURE "ColruytFMC_PROC"."LNK_DTA_SALESTRANSACTIONS_PRODUCTS_INCR"()
 RETURNS varchar 
LANGUAGE JAVASCRIPT 
...
var LNK_TGT = snowflake.createStatement( {sqlText: `
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."LNK_SALESTRANSACTIONS_PRODUCTS_HKEY" ORDER BY "CHANGE_SET"."LOAD_DATE",
	...
	LEFT OUTER JOIN "DV_FL"."LNK_SALESTRANSACTIONS_PRODUCTS" "LNK_SRC" ON  "MIN_LOAD_TIME"."LNK_SALESTRANSACTIONS_PRODUCTS_HKEY" = "LNK_SRC"."LNK_SALESTRANSACTIONS_PRODUCTS_HKEY"
	WHERE  "LNK_SRC"."LNK_SALESTRANSACTIONS_PRODUCTS_HKEY" IS NULL AND "MIN_LOAD_TIME"."DUMMY" = 1
	;
`} ).execute();
