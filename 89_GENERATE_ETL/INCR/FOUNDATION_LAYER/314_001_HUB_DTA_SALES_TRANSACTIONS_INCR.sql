CREATE OR REPLACE PROCEDURE "ColruytFMC_PROC"."HUB_DTA_SALES_TRANSACTIONS_INCR"()
 RETURNS varchar 
LANGUAGE JAVASCRIPT 
...
var HUB_TGT = snowflake.createStatement( {sqlText: `
	...
	LEFT OUTER JOIN "DV_FL"."HUB_SALES_TRANSACTIONS" "HUB_SRC" ON  "MIN_LOAD_TIME"."SALES_TRANSACTIONS_HKEY" = "HUB_SRC"."SALES_TRANSACTIONS_HKEY"
	WHERE  "MIN_LOAD_TIME"."DUMMY" = 1 AND "HUB_SRC"."SALES_TRANSACTIONS_HKEY" is NULL
	;
`} ).execute();
