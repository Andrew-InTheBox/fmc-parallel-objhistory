CREATE OR REPLACE PROCEDURE "ColruytFMC_PROC"."STG_DTA_PRODUCTS_INCR"()
 RETURNS varchar 
LANGUAGE JAVASCRIPT 
...
var STG_TGT = snowflake.createStatement( {sqlText: `
	...
	SELECT 
		...
		, "CALC_HASH_KEYS"."PRODUCT_ID_BK" AS "PRODUCT_ID_BK"
		, "CALC_HASH_KEYS"."PRODUCT_NAME" AS "PRODUCT_NAME"
		, "CALC_HASH_KEYS"."CATEGORY" AS "CATEGORY"
		, "CALC_HASH_KEYS"."BASE_PRICE" AS "BASE_PRICE"
