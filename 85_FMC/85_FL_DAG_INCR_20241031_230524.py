...
Vaultspeed version: 5.7.2.5, generation date: 2024/10/31 23:05:24
...
default_args = {
	...
	"start_date":datetime.strptime("01-01-2020 22:00:00", "%d-%m-%Y %H:%M:%S")
}
...
if (path_to_mtd / "85_mappings_INCR_20241031_230524.json").exists():
	with open(path_to_mtd / "85_mappings_INCR_20241031_230524.json") as file: 
...
if (path_to_mtd / "85_FL_mtd_INCR_20241031_230524.json").exists():
	with open(path_to_mtd / "85_FL_mtd_INCR_20241031_230524.json") as file: 
