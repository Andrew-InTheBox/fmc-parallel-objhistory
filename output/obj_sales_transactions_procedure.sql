    ...
    CREATE OR REPLACE PROCEDURE "ColruytFMC_PROC"."SET_FMC_MTD_FL_INCR_DTA_OBJ_HIST_SALES_TRANSACTIONS"(
    ...
    AS $X$
        ...
        var OBJ_HIST_INS = snowflake.createStatement({sqlText: `
            ...
            WITH "HIST_WINDOW" AS (
                ...
                AND "FMCOH_SRC"."OBJECT_NAME" = 'SALES_TRANSACTIONS'
            )
            SELECT 
                'DT' AS "SRC_BK",
            ...
            FROM "HIST_WINDOW"
            LEFT OUTER JOIN "DEMO_SCHEMA"."SALES_TRANSACTIONS" "CDC_SRC2" ON 1 = 1
